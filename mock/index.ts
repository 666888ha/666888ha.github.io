        ...
        ...Mock.mock({
          list: [
            ...
            },
            {
              ...
              children: [
                {
                  path: '/followUpManagement/list',
                  name: 'list',
                  component: '/followUpManagement/list',
                  meta: {
                    title: {
                      zh_CN: '跟进列表',
                      en_US: 'followUpManagement List',
                    },
                  },
                },
                {
                  ...
                  name: 'add',
                  component: '/followUpManagement/add',
                  meta: {
                    hidden: true, // 隐藏路由
                    title: {
                      zh_CN: '添加跟进',
                      en_US: 'followUpManagement add',
                    },
                  },
                },
                {
                  ...
                  name: 'edit',
                  component: '/followUpManagement/edit',
                  meta: {
                    hidden: true, // 隐藏路由
                    title: {
                      zh_CN: '编辑跟进',
                      en_US: 'followUpManagement edit',
                    },
                  },
                },
              ],
