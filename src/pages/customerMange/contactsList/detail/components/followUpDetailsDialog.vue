<template>
  ...
  <newFollowUpDialog ref="newFollowUp" @submit-success="handleEditSuccess" />
</template>
...
const newFollowUpDialog = defineAsyncComponent(() => import('./addFollowUp.vue'));
...
const clickOper = (type: number) => {
  switch (type) {
    ...
    case 3: // 编辑跟进
      ...
      newFollowUp.value.show(recordDetail.value, 2);
      break;
    case 4:
      handleDeleteRecord(recordDetail.value);
      break;
    default:
      break;
  }
